...
export default function Header({
  ...
  const studentInfo = {
    ...
    plan: profileData?.plan?.name || "Free Plan",
          ...
          {isTeacherOrStudent && (
            <div className="flex items-center gap-2 md:gap-8 max-w-full">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 md:px-8 py-2 md:py-3.5 rounded-full md:rounded-2xl text-[10px] md:text-sm font-bold whitespace-nowrap transition-all ${isSessionReady
